 ...
 *      Author: Victor Zappi
 *      Comments: see comments below. Thanks Julien Pommier!
 */
...
/* natural logarithm computed for 4 simultaneous float
   return NaN for x <= 0
*/
inline v4sf log_ps(v4sf x) { //VIC made all these functions inline for multiple inclusions
#ifdef USE_SSE2
  v4si emm0;
#else
  v2si mm0, mm1;
